import { Injectable, EventEmitter, ChangeDetectorRef, Inject, LOCALE_ID, Component, ViewEncapsulation, Input, Output, HostListener, ElementRef, Pipe, InjectionToken, NgModule } from '@angular/core';
...
import * as ɵngcc1 from 'angular-calendar';
import * as ɵngcc2 from '@angular/cdk/layout';
import * as ɵngcc3 from '@angular/common';
import * as ɵngcc4 from 'angular-draggable-droppable';
import * as ɵngcc5 from 'angular-resizable-element';

function CalendarSchedulerViewComponent_div_5_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵstyleProp("height", ctx_r5.hourSegmentHeight, "px");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ɵngcc0.ɵɵpipeBind3(2, 3, segment_r6.date, "dayViewHour", ctx_r5.locale), " ");
} }
function CalendarSchedulerViewComponent_div_5_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementStart(0, "div", 9);
    ɵngcc0.ɵɵelementStart(1, "div", 10);
    ɵngcc0.ɵɵtemplate(2, CalendarSchedulerViewComponent_div_5_div_2_Template, 3, 7, "div", 11);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const hour_r4 = ctx.$implicit;
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngForOf", hour_r4.segments);
} }
const _c0 = function () { return { left: true, top: true }; };
function CalendarSchedulerViewComponent_div_8_div_1_div_2_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "div", 21);
} if (rf & 2) {
    ɵngcc0.ɵɵproperty("resizeEdges", ɵngcc0.ɵɵpureFunction0(1, _c0));
} }
const _c1 = function () { return { right: true, bottom: true }; };
function CalendarSchedulerViewComponent_div_8_div_1_div_4_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "div", 22);
} if (rf & 2) {
    ɵngcc0.ɵɵproperty("resizeEdges", ɵngcc0.ɵɵpureFunction0(1, _c1));
} }
const _c2 = function (a0, a1, a2, a3) { return { left: a0, right: a1, top: a2, bottom: a3 }; };
const _c3 = function (a0, a1) { return { event: a0, calendarId: a1 }; };
const _c4 = function (a0, a1) { return { x: a0, y: a1 }; };
const _c5 = function () { return {}; };
function CalendarSchedulerViewComponent_div_8_div_1_Template(rf, ctx) { if (rf & 1) {
    const _r15 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 16, 17);
    ɵngcc0.ɵɵlistener("resizeStart", function CalendarSchedulerViewComponent_div_8_div_1_Template_div_resizeStart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r15); const event_r10 = ctx.$implicit; const ctx_r14 = ɵngcc0.ɵɵnextContext(2); const _r2 = ɵngcc0.ɵɵreference(7); return ctx_r14.resizeStarted(_r2, event_r10, $event); })("resizing", function CalendarSchedulerViewComponent_div_8_div_1_Template_div_resizing_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r15); const event_r10 = ctx.$implicit; const ctx_r16 = ɵngcc0.ɵɵnextContext(2); return ctx_r16.resizing(event_r10, $event); })("resizeEnd", function CalendarSchedulerViewComponent_div_8_div_1_Template_div_resizeEnd_0_listener() { ɵngcc0.ɵɵrestoreView(_r15); const event_r10 = ctx.$implicit; const ctx_r17 = ɵngcc0.ɵɵnextContext(2); return ctx_r17.resizeEnded(event_r10); })("dragPointerDown", function CalendarSchedulerViewComponent_div_8_div_1_Template_div_dragPointerDown_0_listener() { ɵngcc0.ɵɵrestoreView(_r15); const event_r10 = ctx.$implicit; const _r11 = ɵngcc0.ɵɵreference(1); const ctx_r18 = ɵngcc0.ɵɵnextContext(2); const _r2 = ɵngcc0.ɵɵreference(7); return ctx_r18.dragStarted(_r2, _r11, event_r10); })("dragging", function CalendarSchedulerViewComponent_div_8_div_1_Template_div_dragging_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r15); const event_r10 = ctx.$implicit; const ctx_r19 = ɵngcc0.ɵɵnextContext(2); return ctx_r19.dragMove(event_r10, $event); })("dragEnd", function CalendarSchedulerViewComponent_div_8_div_1_Template_div_dragEnd_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r15); const event_r10 = ctx.$implicit; const ctx_r20 = ɵngcc0.ɵɵnextContext(2); return ctx_r20.dragEnded(event_r10, $event, ctx_r20.dayColumnWidth, true); });
    ɵngcc0.ɵɵtemplate(2, CalendarSchedulerViewComponent_div_8_div_1_div_2_Template, 1, 2, "div", 18);
    ɵngcc0.ɵɵelementStart(3, "calendar-scheduler-event", 19);
    ɵngcc0.ɵɵlistener("eventClicked", function CalendarSchedulerViewComponent_div_8_div_1_Template_calendar_scheduler_event_eventClicked_3_listener($event) { ɵngcc0.ɵɵrestoreView(_r15); const ctx_r21 = ɵngcc0.ɵɵnextContext(2); return ctx_r21.eventClicked.emit($event); });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵtemplate(4, CalendarSchedulerViewComponent_div_8_div_1_div_4_Template, 1, 2, "div", 20);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    ...
    ɵngcc0.ɵɵstyleProp("top", event_r10.top, "px")("height", event_r10.height, "px")("left", event_r10.left, "%")("width", event_r10.width, "%");
    ɵngcc0.ɵɵclassProp("zoom-on-hover", ctx_r8.zoomEventOnHover);
    ɵngcc0.ɵɵproperty("ngClass", event_r10.event == null ? null : event_r10.event.cssClass)("hidden", event_r10.height === 0 && event_r10.width === 0)("resizeSnapGrid", ɵngcc0.ɵɵpureFunction4(30, _c2, ctx_r8.dayColumnWidth, ctx_r8.dayColumnWidth, ctx_r8.eventSnapSize || ctx_r8.hourSegmentHeight, ctx_r8.eventSnapSize || ctx_r8.hourSegmentHeight))("validateResize", ctx_r8.validateResize)("allowNegativeResizes", true)("dropData", ɵngcc0.ɵɵpureFunction2(35, _c3, event_r10.event, ctx_r8.calendarId))("dragAxis", ɵngcc0.ɵɵpureFunction2(38, _c4, event_r10.event.draggable && ctx_r8.resizes.size === 0, event_r10.event.draggable && ctx_r8.resizes.size === 0))("dragSnapGrid", ctx_r8.snapDraggedEvents ? ɵngcc0.ɵɵpureFunction2(41, _c4, ctx_r8.dayColumnWidth, ctx_r8.eventSnapSize || ctx_r8.hourSegmentHeight) : ɵngcc0.ɵɵpureFunction0(44, _c5))("ghostDragEnabled", !ctx_r8.snapDraggedEvents)("validateDrag", ctx_r8.validateDrag);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", (event_r10.event == null ? null : event_r10.event.resizable == null ? null : event_r10.event.resizable.beforeStart) && !event_r10.startsBeforeDay);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("day", day_r7)("event", event_r10)("container", _r11)("showContent", ctx_r8.showEventContent && event_r10.height >= 75)("showActions", ctx_r8.showEventActions)("showStatus", ctx_r8.showEventStatus)("customTemplate", ctx_r8.eventTemplate)("eventTitleTemplate", ctx_r8.eventTitleTemplate);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", (event_r10.event == null ? null : event_r10.event.resizable == null ? null : event_r10.event.resizable.afterEnd) && !event_r10.endsAfterDay);
} }
function CalendarSchedulerViewComponent_div_8_div_2_calendar_scheduler_hour_segment_2_Template(rf, ctx) { if (rf & 1) {
    const _r28 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "calendar-scheduler-hour-segment", 26);
    ɵngcc0.ɵɵlistener("segmentClicked", function CalendarSchedulerViewComponent_div_8_div_2_calendar_scheduler_hour_segment_2_Template_calendar_scheduler_hour_segment_segmentClicked_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r28); const ctx_r27 = ɵngcc0.ɵɵnextContext(3); return ctx_r27.segmentClicked.emit($event); })("drop", function CalendarSchedulerViewComponent_div_8_div_2_calendar_scheduler_hour_segment_2_Template_calendar_scheduler_hour_segment_drop_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r28); const segment_r26 = ctx.$implicit; const ctx_r29 = ɵngcc0.ɵɵnextContext(3); return ctx_r29.eventDropped($event, segment_r26.date); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const segment_r26 = ctx.$implicit;
    const day_r7 = ɵngcc0.ɵɵnextContext(2).$implicit;
    const ctx_r25 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("day", day_r7)("segment", segment_r26)("locale", ctx_r25.locale)("customTemplate", ctx_r25.cellTemplate)("hourSegmentHeight", ctx_r25.hourSegmentHeight)("showHour", ctx_r25.showSegmentHour)("dragOverClass", !ctx_r25.dragActive || !ctx_r25.snapDraggedEvents ? "cal-drag-over" : "null");
} }
function CalendarSchedulerViewComponent_div_8_div_2_Template(rf, ctx) { if (rf & 1) {
    const _r32 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 23);
    ɵngcc0.ɵɵlistener("mwlClick", function CalendarSchedulerViewComponent_div_8_div_2_Template_div_mwlClick_0_listener() { ɵngcc0.ɵɵrestoreView(_r32); const hour_r23 = ctx.$implicit; const ctx_r31 = ɵngcc0.ɵɵnextContext(2); return ctx_r31.hourClicked.emit({ hour: hour_r23 }); });
    ɵngcc0.ɵɵelementStart(1, "div", 24);
    ɵngcc0.ɵɵtemplate(2, CalendarSchedulerViewComponent_div_8_div_2_calendar_scheduler_hour_segment_2_Template, 1, 7, "calendar-scheduler-hour-segment", 25);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    ...
    ɵngcc0.ɵɵstyleProp("background-color", hour_r23.backgroundColor);
    ɵngcc0.ɵɵclassProp("cal-even", i_r24 % 2 === 0)("cal-odd", i_r24 % 2 === 1)("cal-past", day_r7.isPast)("cal-today", day_r7.isToday)("cal-future", day_r7.isFuture)("cal-weekend", day_r7.isWeekend)("cal-in-month", day_r7.inMonth)("cal-out-month", !day_r7.inMonth);
    ɵngcc0.ɵɵproperty("ngClass", hour_r23.cssClass);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngForOf", hour_r23.segments)("ngForTrackBy", ctx_r9.trackByHourSegment);
} }
function CalendarSchedulerViewComponent_div_8_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementStart(0, "div", 13);
    ɵngcc0.ɵɵtemplate(1, CalendarSchedulerViewComponent_div_8_div_1_Template, 5, 45, "div", 14);
    ɵngcc0.ɵɵtemplate(2, CalendarSchedulerViewComponent_div_8_div_2_Template, 3, 21, "div", 15);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const day_r7 = ctx.$implicit;
    const ctx_r3 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("background-color", day_r7.backgroundColor);
    ɵngcc0.ɵɵproperty("ngClass", day_r7 == null ? null : day_r7.cssClass);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", day_r7.events)("ngForTrackBy", ctx_r3.trackByDayOrEvent);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", day_r7.hours)("ngForTrackBy", ctx_r3.trackByHour);
} }
function CalendarSchedulerHourSegmentComponent_ng_template_0_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ɵngcc0.ɵɵpipeBind3(2, 1, ctx_r3.segment.date, "dayViewHour", ctx_r3.locale), " ");
} }
function CalendarSchedulerHourSegmentComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    const _r5 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 2);
    ɵngcc0.ɵɵlistener("mwlClick", function CalendarSchedulerHourSegmentComponent_ng_template_0_Template_div_mwlClick_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r5); const ctx_r4 = ɵngcc0.ɵɵnextContext(); return ctx_r4.onSegmentClick($event, ctx_r4.segment); });
    ɵngcc0.ɵɵtemplate(1, CalendarSchedulerHourSegmentComponent_ng_template_0_div_1_Template, 3, 5, "div", 3);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("background-color", ctx_r1.segment.backgroundColor)("height", ctx_r1.hourSegmentHeight, "px");
    ɵngcc0.ɵɵclassProp("has-events", ctx_r1.segment.events.length > 0)("cal-cancelled", ctx_r1.segment.isCancelled)("cal-disabled", ctx_r1.segment.isDisabled);
    ɵngcc0.ɵɵproperty("title", ctx_r1.title)("ngClass", ctx_r1.segment == null ? null : ctx_r1.segment.cssClass);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r1.showHour && ctx_r1.segment.events.length === 0);
} }
function CalendarSchedulerHourSegmentComponent_ng_template_2_Template(rf, ctx) { }
const _c6 = function (a0, a1, a2, a3, a4, a5, a6) { return { title: a0, day: a1, segment: a2, locale: a3, hourSegmentHeight: a4, showHour: a5, segmentClicked: a6 }; };
function CalendarSchedulerHeaderComponent_ng_template_0_div_5_Template(rf, ctx) { if (rf & 1) {
    const _r6 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 7);
    ɵngcc0.ɵɵlistener("mwlClick", function CalendarSchedulerHeaderComponent_ng_template_0_div_5_Template_div_mwlClick_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r6); const day_r4 = ctx.$implicit; const ctx_r5 = ɵngcc0.ɵɵnextContext(2); return ctx_r5.onDayHeaderClick($event, day_r4); });
    ...
    const ctx_r3 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵclassProp("cal-past", day_r4.isPast)("cal-today", day_r4.isToday)("cal-future", day_r4.isFuture)("cal-weekend", day_r4.isWeekend);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ɵngcc0.ɵɵpipeBind3(3, 10, day_r4.date, "weekViewColumnHeader", ctx_r3.locale));
    ɵngcc0.ɵɵadvance(4);
    ɵngcc0.ɵɵtextInterpolate(ɵngcc0.ɵɵpipeBind3(7, 14, day_r4.date, "weekViewColumnSubHeader", ctx_r3.locale));
} }
function CalendarSchedulerHeaderComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementStart(0, "div", 2);
    ɵngcc0.ɵɵelementStart(1, "div", 3);
    ɵngcc0.ɵɵelementStart(2, "i", 4);
    ɵngcc0.ɵɵtext(3, "schedule");
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(4, "div", 5);
    ɵngcc0.ɵɵtemplate(5, CalendarSchedulerHeaderComponent_ng_template_0_div_5_Template, 8, 18, "div", 6);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(5);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r1.days);
} }
function CalendarSchedulerHeaderComponent_ng_template_2_Template(rf, ctx) { }
const _c7 = function (a0, a1, a2) { return { days: a0, locale: a1, dayHeaderClicked: a2 }; };
function CalendarSchedulerEventComponent_ng_template_0_calendar_scheduler_event_content_2_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "calendar-scheduler-event-content", 6);
} if (rf & 2) {
    const ctx_r3 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("event", ctx_r3.event.event)("eventContainer", ctx_r3.container);
} }
function CalendarSchedulerEventComponent_ng_template_0_calendar_scheduler_event_actions_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "calendar-scheduler-event-actions", 7);
} if (rf & 2) {
    const ctx_r4 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("event", ctx_r4.event.event);
} }
function CalendarSchedulerEventComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    const _r6 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 2);
    ɵngcc0.ɵɵlistener("mwlClick", function CalendarSchedulerEventComponent_ng_template_0_Template_div_mwlClick_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r6); const ctx_r5 = ɵngcc0.ɵɵnextContext(); return ctx_r5.onEventClick($event, ctx_r5.event.event); })("mouseenter", function CalendarSchedulerEventComponent_ng_template_0_Template_div_mouseenter_0_listener() { ɵngcc0.ɵɵrestoreView(_r6); const ctx_r7 = ɵngcc0.ɵɵnextContext(); return ctx_r7.onMouseEnter(); })("mouseleave", function CalendarSchedulerEventComponent_ng_template_0_Template_div_mouseleave_0_listener() { ɵngcc0.ɵɵrestoreView(_r6); const ctx_r8 = ɵngcc0.ɵɵnextContext(); return ctx_r8.onMouseLeave(); });
    ɵngcc0.ɵɵelement(1, "calendar-scheduler-event-title", 3);
    ɵngcc0.ɵɵtemplate(2, CalendarSchedulerEventComponent_ng_template_0_calendar_scheduler_event_content_2_Template, 1, 2, "calendar-scheduler-event-content", 4);
    ɵngcc0.ɵɵtemplate(3, CalendarSchedulerEventComponent_ng_template_0_calendar_scheduler_event_actions_3_Template, 1, 1, "calendar-scheduler-event-actions", 5);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("max-width", ctx_r1.container.clientWidth - 4, "px")("background-color", ctx_r1.event.event.color == null ? null : ctx_r1.event.event.color.secondary)("border-color", ctx_r1.event.event.color == null ? null : ctx_r1.event.event.color.primary);
    ɵngcc0.ɵɵclassProp("cal-cancelled", ctx_r1.event.event.isCancelled)("cal-disabled", ctx_r1.event.event.isDisabled)("cal-not-clickable", !ctx_r1.event.event.isClickable)("cal-draggable", ctx_r1.event.event.draggable)("cal-starts-before-day", ctx_r1.event.startsBeforeDay)("cal-ends-after-day", ctx_r1.event.endsAfterDay);
    ɵngcc0.ɵɵproperty("title", ctx_r1.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("event", ctx_r1.event.event)("showStatus", ctx_r1.showStatus)("showContent", ctx_r1.showContent)("showActions", ctx_r1.showActions)("customTemplate", ctx_r1.eventTitleTemplate);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r1.showContent);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r1.showActions && ctx_r1.showContent && (ctx_r1.event.event.isClickable || ctx_r1.event.event.isDisabled));
} }
function CalendarSchedulerEventComponent_ng_template_2_Template(rf, ctx) { }
const _c8 = function (a0, a1, a2, a3, a4, a5, a6, a7) { return { title: a0, day: a1, event: a2, showContent: a3, showActions: a4, showStatus: a5, eventTitleTemplate: a6, eventClicked: a7 }; };
function CalendarSchedulerEventTitleComponent_ng_template_0_calendar_scheduler_event_actions_2_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "calendar-scheduler-event-actions", 5);
} if (rf & 2) {
    const ctx_r3 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("event", ctx_r3.event);
} }
function CalendarSchedulerEventTitleComponent_ng_template_0_div_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "div", 6);
} if (rf & 2) {
    const ctx_r4 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵclassProp("ok", ctx_r4.event.status === "ok")("warning", ctx_r4.event.status === "warning")("danger", ctx_r4.event.status === "danger");
} }
function CalendarSchedulerEventTitleComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "div", 2);
    ɵngcc0.ɵɵpipe(1, "schedulerEventTitle");
    ɵngcc0.ɵɵtemplate(2, CalendarSchedulerEventTitleComponent_ng_template_0_calendar_scheduler_event_actions_2_Template, 1, 1, "calendar-scheduler-event-actions", 3);
    ɵngcc0.ɵɵtemplate(3, CalendarSchedulerEventTitleComponent_ng_template_0_div_3_Template, 1, 6, "div", 4);
} if (rf & 2) {
    const ctx_r1 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("innerHTML", ɵngcc0.ɵɵpipeBind3(1, 3, ctx_r1.event.title, ctx_r1.view, ctx_r1.event), ɵngcc0.ɵɵsanitizeHtml);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r1.showActions && !ctx_r1.showContent && (ctx_r1.event.isClickable || ctx_r1.event.isDisabled));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r1.event.status && ctx_r1.showStatus);
} }
function CalendarSchedulerEventTitleComponent_ng_template_2_Template(rf, ctx) { }
const _c9 = function (a0, a1, a2, a3, a4) { return { view: a0, event: a1, showStatus: a2, showContent: a3, showActions: a4 }; };
function CalendarSchedulerEventContentComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "div", 1);
} if (rf & 2) {
    const ctx_r0 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("max-height", ctx_r0.maxHeight, "px");
    ɵngcc0.ɵɵproperty("innerHTML", ctx_r0.maxHeight && ctx_r0.maxHeight >= 30 ? ctx_r0.event.content : null, ɵngcc0.ɵɵsanitizeHtml);
} }
function CalendarSchedulerEventActionsComponent_span_0_a_1_Template(rf, ctx) { if (rf & 1) {
    const _r4 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "a", 3);
    ɵngcc0.ɵɵlistener("mwlClick", function CalendarSchedulerEventActionsComponent_span_0_a_1_Template_a_mwlClick_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r4); const action_r2 = ctx.$implicit; const ctx_r3 = ɵngcc0.ɵɵnextContext(2); return ctx_r3.onActionClick($event, action_r2, ctx_r3.event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const action_r2 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngClass", action_r2.cssClass)("innerHtml", action_r2.label, ɵngcc0.ɵɵsanitizeHtml)("title", action_r2.title);
} }
function CalendarSchedulerEventActionsComponent_span_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelementStart(0, "span", 1);
    ɵngcc0.ɵɵtemplate(1, CalendarSchedulerEventActionsComponent_span_0_a_1_Template, 1, 3, "a", 2);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r0 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
...
SchedulerConfig.ɵfac = function SchedulerConfig_Factory(t) { return new (t || SchedulerConfig)(ɵngcc0.ɵɵinject(SchedulerConfig)); };
SchedulerConfig.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: SchedulerConfig, factory: SchedulerConfig.ɵfac });
SchedulerConfig.ctorParameters = () => [
    { type: SchedulerConfig }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SchedulerConfig, [{
        type: Injectable
    }], function () { return [{ type: SchedulerConfig }]; }, null); })();
SchedulerConfig.ctorParameters = () => [
    { type: SchedulerConfig }
];
...
CalendarSchedulerUtils.ɵfac = function CalendarSchedulerUtils_Factory(t) { return new (t || CalendarSchedulerUtils)(ɵngcc0.ɵɵinject(ɵngcc1.DateAdapter)); };
CalendarSchedulerUtils.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: CalendarSchedulerUtils, factory: CalendarSchedulerUtils.ɵfac });
CalendarSchedulerUtils.ctorParameters = () => [
    { type: DateAdapter }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CalendarSchedulerUtils, [{
        type: Injectable
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CalendarSchedulerViewComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc0.ChangeDetectorRef }, { type: String, decorators: [{
                type: Inject,
                args: [LOCALE_ID]
            }] }, { type: SchedulerConfig }, { type: CalendarSchedulerUtils }, { type: ɵngcc1.DateAdapter }, { type: ɵngcc2.MediaMatcher }, { type: ɵngcc0.ChangeDetectorRef }]; }, { events: [{
            type: Input
        }], hourSegments: [{
            type: Input
        }], hourSegmentHeight: [{
...
CalendarSchedulerHourSegmentComponent.ɵfac = function CalendarSchedulerHourSegmentComponent_Factory(t) { return new (t || CalendarSchedulerHourSegmentComponent)(); };
CalendarSchedulerHourSegmentComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: CalendarSchedulerHourSegmentComponent, selectors: [["calendar-scheduler-hour-segment"]], inputs: { hourSegmentHeight: "hourSegmentHeight", showHour: "showHour", title: "title", day: "day", segment: "segment", locale: "locale", customTemplate: "customTemplate" }, outputs: { segmentClicked: "segmentClicked" }, decls: 3, vars: 10, consts: [["defaultTemplate", ""], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "cal-scheduler-hour-segment", 3, "title", "ngClass", "mwlClick"], ["class", "cal-scheduler-time unselectable", 4, "ngIf"], [1, "cal-scheduler-time", "unselectable"]], template: function CalendarSchedulerHourSegmentComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, CalendarSchedulerHourSegmentComponent_ng_template_0_Template, 2, 13, "ng-template", null, 0, ɵngcc0.ɵɵtemplateRefExtractor);
        ɵngcc0.ɵɵtemplate(2, CalendarSchedulerHourSegmentComponent_ng_template_2_Template, 0, 0, "ng-template", 1);
    } if (rf & 2) {
        const _r0 = ɵngcc0.ɵɵreference(1);
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx.customTemplate || _r0)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction7(2, _c6, ctx.title, ctx.day, ctx.segment, ctx.locale, ctx.hourSegmentHeight, ctx.showHour, ctx.segmentClicked));
    } }, directives: [ɵngcc3.NgTemplateOutlet, ɵngcc3.NgClass, ɵngcc1.ɵl, ɵngcc3.NgIf], pipes: [ɵngcc1.ɵi], encapsulation: 2 });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CalendarSchedulerHourSegmentComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return []; }, { hourSegmentHeight: [{
            type: Input
        }], showHour: [{
            type: Input
        }], segmentClicked: [{
...
CalendarSchedulerHeaderComponent.ɵfac = function CalendarSchedulerHeaderComponent_Factory(t) { return new (t || CalendarSchedulerHeaderComponent)(); };
CalendarSchedulerHeaderComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: CalendarSchedulerHeaderComponent, selectors: [["calendar-scheduler-header"]], inputs: { days: "days", locale: "locale", customTemplate: "customTemplate" }, outputs: { dayHeaderClicked: "dayHeaderClicked" }, decls: 3, vars: 6, consts: [["defaultTemplate", ""], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "cal-scheduler-headers"], [1, "cal-header", "aside", "cal-header-clock", "align-center"], [1, "material-icons", "md-32", 2, "margin", "auto"], [1, "cal-header-cols", "aside"], ["class", "cal-header", 3, "cal-past", "cal-today", "cal-future", "cal-weekend", "mwlClick", 4, "ngFor", "ngForOf"], [1, "cal-header", 3, "mwlClick"]], template: function CalendarSchedulerHeaderComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, CalendarSchedulerHeaderComponent_ng_template_0_Template, 6, 1, "ng-template", null, 0, ɵngcc0.ɵɵtemplateRefExtractor);
        ɵngcc0.ɵɵtemplate(2, CalendarSchedulerHeaderComponent_ng_template_2_Template, 0, 0, "ng-template", 1);
    } if (rf & 2) {
        const _r0 = ɵngcc0.ɵɵreference(1);
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx.customTemplate || _r0)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction3(2, _c7, ctx.days, ctx.locale, ctx.dayHeaderClicked));
    } }, directives: [ɵngcc3.NgTemplateOutlet, ɵngcc3.NgForOf, ɵngcc1.ɵl], pipes: [ɵngcc1.ɵi], encapsulation: 2 });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CalendarSchedulerHeaderComponent, [{
        type: Component,
        args: [{
...
CalendarSchedulerEventComponent.ɵfac = function CalendarSchedulerEventComponent_Factory(t) { return new (t || CalendarSchedulerEventComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef)); };
CalendarSchedulerEventComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: CalendarSchedulerEventComponent, selectors: [["calendar-scheduler-event"]], hostVars: 2, hostBindings: function CalendarSchedulerEventComponent_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵstyleProp("height", 100, "%");
    } }, inputs: { showContent: "showContent", showActions: "showActions", showStatus: "showStatus", title: "title", day: "day", event: "event", container: "container", customTemplate: "customTemplate", eventTitleTemplate: "eventTitleTemplate" }, outputs: { eventClicked: "eventClicked" }, decls: 3, vars: 11, consts: [["defaultTemplate", ""], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "cal-scheduler-event", 3, "title", "mwlClick", "mouseenter", "mouseleave"], ["view", "week", 3, "event", "showStatus", "showContent", "showActions", "customTemplate"], [3, "event", "eventContainer", 4, "ngIf"], [3, "event", 4, "ngIf"], [3, "event", "eventContainer"], [3, "event"]], template: function CalendarSchedulerEventComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, CalendarSchedulerEventComponent_ng_template_0_Template, 4, 26, "ng-template", null, 0, ɵngcc0.ɵɵtemplateRefExtractor);
        ɵngcc0.ɵɵtemplate(2, CalendarSchedulerEventComponent_ng_template_2_Template, 0, 0, "ng-template", 1);
    } if (rf & 2) {
        const _r0 = ɵngcc0.ɵɵreference(1);
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx.customTemplate || _r0)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction8(2, _c8, ctx.title, ctx.day, ctx.event, ctx.showContent, ctx.showActions, ctx.showStatus, ctx.eventTitleTemplate, ctx.eventClicked));
    } }, directives: function () { return [ɵngcc3.NgTemplateOutlet, ɵngcc1.ɵl, CalendarSchedulerEventTitleComponent, ɵngcc3.NgIf, CalendarSchedulerEventContentComponent,
        CalendarSchedulerEventActionsComponent]; }, encapsulation: 2 });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CalendarSchedulerEventComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc0.ChangeDetectorRef }]; }, { showContent: [{
            type: Input
        }], showActions: [{
            type: Input
        }], showStatus: [{
...
CalendarSchedulerEventTitleComponent.ɵfac = function CalendarSchedulerEventTitleComponent_Factory(t) { return new (t || CalendarSchedulerEventTitleComponent)(); };
CalendarSchedulerEventTitleComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: CalendarSchedulerEventTitleComponent, selectors: [["calendar-scheduler-event-title"]], hostAttrs: [1, "cal-scheduler-event-title-container"], inputs: { showStatus: "showStatus", showContent: "showContent", showActions: "showActions", view: "view", event: "event", customTemplate: "customTemplate" }, decls: 3, vars: 8, consts: [["defaultTemplate", ""], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "cal-scheduler-event-title", 3, "innerHTML"], ["class", "no-content-actions", 3, "event", 4, "ngIf"], ["class", "cal-scheduler-event-status", 3, "ok", "warning", "danger", 4, "ngIf"], [1, "no-content-actions", 3, "event"], [1, "cal-scheduler-event-status"]], template: function CalendarSchedulerEventTitleComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, CalendarSchedulerEventTitleComponent_ng_template_0_Template, 4, 7, "ng-template", null, 0, ɵngcc0.ɵɵtemplateRefExtractor);
        ɵngcc0.ɵɵtemplate(2, CalendarSchedulerEventTitleComponent_ng_template_2_Template, 0, 0, "ng-template", 1);
    } if (rf & 2) {
        const _r0 = ɵngcc0.ɵɵreference(1);
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx.customTemplate || _r0)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction5(2, _c9, ctx.view, ctx.event, ctx.showStatus, ctx.showContent, ctx.showActions));
    } }, directives: function () { return [ɵngcc3.NgTemplateOutlet, ɵngcc3.NgIf, CalendarSchedulerEventActionsComponent]; }, pipes: function () { return [SchedulerEventTitlePipe]; }, encapsulation: 2 });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CalendarSchedulerEventTitleComponent, [{
        type: Component,
        args: [{
...
CalendarSchedulerEventContentComponent.ɵfac = function CalendarSchedulerEventContentComponent_Factory(t) { return new (t || CalendarSchedulerEventContentComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
CalendarSchedulerEventContentComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: CalendarSchedulerEventContentComponent, selectors: [["calendar-scheduler-event-content"]], hostAttrs: [1, "cal-scheduler-event-content-container"], inputs: { event: "event", eventContainer: "eventContainer" }, decls: 1, vars: 1, consts: [["class", "cal-scheduler-event-content", 3, "max-height", "innerHTML", 4, "ngIf"], [1, "cal-scheduler-event-content", 3, "innerHTML"]], template: function CalendarSchedulerEventContentComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, CalendarSchedulerEventContentComponent_div_0_Template, 1, 3, "div", 0);
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("ngIf", ctx.event.content);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CalendarSchedulerEventContentComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }]; }, { event: [{
            type: Input
        }], eventContainer: [{
            type: Input
        }] }); })();
...
CalendarSchedulerEventActionsComponent.ɵfac = function CalendarSchedulerEventActionsComponent_Factory(t) { return new (t || CalendarSchedulerEventActionsComponent)(); };
CalendarSchedulerEventActionsComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: CalendarSchedulerEventActionsComponent, selectors: [["calendar-scheduler-event-actions"]], hostAttrs: [1, "cal-scheduler-event-actions-container"], inputs: { event: "event" }, features: [ɵngcc0.ɵɵNgOnChangesFeature], decls: 1, vars: 1, consts: [["class", "cal-scheduler-event-actions", 4, "ngIf"], [1, "cal-scheduler-event-actions"], ["class", "cal-scheduler-event-action", "href", "javascript:;", 3, "ngClass", "innerHtml", "title", "mwlClick", 4, "ngFor", "ngForOf"], ["href", "javascript:;", 1, "cal-scheduler-event-action", 3, "ngClass", "innerHtml", "title", "mwlClick"]], template: function CalendarSchedulerEventActionsComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, CalendarSchedulerEventActionsComponent_span_0_Template, 2, 1, "span", 0);
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("ngIf", ctx.event.actions);
    } }, directives: [ɵngcc3.NgIf, ɵngcc3.NgForOf, ɵngcc3.NgClass, ɵngcc1.ɵl], encapsulation: 2 });
CalendarSchedulerEventActionsComponent.propDecorators = {
    event: [{ type: Input }]
};
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CalendarSchedulerEventActionsComponent, [{
        type: Component,
        args: [{
...
SchedulerEventTitleFormatter.ɵfac = function SchedulerEventTitleFormatter_Factory(t) { return ɵSchedulerEventTitleFormatter_BaseFactory(t || SchedulerEventTitleFormatter); };
SchedulerEventTitleFormatter.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: SchedulerEventTitleFormatter, factory: SchedulerEventTitleFormatter.ɵfac });
const ɵSchedulerEventTitleFormatter_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(SchedulerEventTitleFormatter);
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SchedulerEventTitleFormatter, [{
        type: Injectable
    }], null, null); })();
...
SchedulerEventTitlePipe.ɵfac = function SchedulerEventTitlePipe_Factory(t) { return new (t || SchedulerEventTitlePipe)(ɵngcc0.ɵɵdirectiveInject(SchedulerEventTitleFormatter)); };
SchedulerEventTitlePipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "schedulerEventTitle", type: SchedulerEventTitlePipe, pure: true });
SchedulerEventTitlePipe.ctorParameters = () => [
    { type: SchedulerEventTitleFormatter }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SchedulerEventTitlePipe, [{
        type: Pipe,
        args: [{
                name: 'schedulerEventTitle'
            }]
    }], function () { return [{ type: SchedulerEventTitleFormatter }]; }, null); })();
SchedulerEventTitlePipe.ctorParameters = () => [
    { type: SchedulerEventTitleFormatter }
];
...
CalendarSchedulerDatePipe.ɵfac = function CalendarSchedulerDatePipe_Factory(t) { return new (t || CalendarSchedulerDatePipe)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.DateAdapter), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.CalendarDateFormatter), ɵngcc0.ɵɵdirectiveInject(LOCALE_ID)); };
CalendarSchedulerDatePipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "calendarSchedulerDate", type: CalendarSchedulerDatePipe, pure: true });
CalendarSchedulerDatePipe.ctorParameters = () => [
    { type: DateAdapter },
    { type: CalendarDateFormatter },
    { type: String, decorators: [{ type: Inject, args: [LOCALE_ID,] }] }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CalendarSchedulerDatePipe, [{
        type: Pipe,
        args: [{
                name: 'calendarSchedulerDate'
            }]
    }], function () { return [{ type: ɵngcc1.DateAdapter }, { type: ɵngcc1.CalendarDateFormatter }, { type: String, decorators: [{
                type: Inject,
                args: [LOCALE_ID]
            }] }]; }, null); })();
CalendarSchedulerDatePipe.ctorParameters = () => [
...
SchedulerDateFormatter.ɵfac = function SchedulerDateFormatter_Factory(t) { return new (t || SchedulerDateFormatter)(ɵngcc0.ɵɵinject(ɵngcc1.DateAdapter)); };
SchedulerDateFormatter.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: SchedulerDateFormatter, factory: SchedulerDateFormatter.ɵfac });
SchedulerDateFormatter.ctorParameters = () => [
    { type: DateAdapter }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SchedulerDateFormatter, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc1.DateAdapter }]; }, null); })();
SchedulerDateFormatter.ctorParameters = () => [
    { type: DateAdapter }
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(SchedulerModule, { declarations: function () { return [CalendarSchedulerViewComponent,
        ...
        SchedulerEventTitlePipe,
        CalendarSchedulerDatePipe]; }, imports: function () { return [CommonModule, ɵngcc1.CalendarModule]; }, exports: function () { return [CalendarSchedulerDatePipe,
